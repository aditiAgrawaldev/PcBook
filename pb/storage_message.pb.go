...
type Storage struct {
	...
	Driver        Storage_Driver         `protobuf:"varint,1,opt,name=driver,proto3,enum=storage.Storage_Driver" json:"driver,omitempty"`
...
const file_storage_message_proto_rawDesc = "" +
	"\n" +
	"\x15storage_message.proto\x12\astorage\x1a\x14memory_message.proto\"\x8b\x01\n" +
	"\aStorage\x12/\n" +
	"\x06driver\x18\x01 \x01(\x0e2\x17.storage.Storage.DriverR\x06driver\x12&\n" +
	"\x06memory\x18\x02 \x01(\v2\x0e.memory.MemoryR\x06memory\"'\n" +
	"\x06Driver\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\a\n" +
	"\x03HDD\x10\x01\x12\a\n" +
	"\x03SSD\x10\x02B\x0eZ\fpcBook/pb;pbb\x06proto3"
...
var file_storage_message_proto_goTypes = []any{
	(Storage_Driver)(0), // 0: storage.Storage.Driver
	(*Storage)(nil),     // 1: storage.Storage
	(*Memory)(nil),      // 2: memory.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: storage.Storage.driver:type_name -> storage.Storage.Driver
	2, // 1: storage.Storage.memory:type_name -> memory.Memory
