...
type Memory struct {
	...
	Unit          Memory_Unit            `protobuf:"varint,2,opt,name=unit,proto3,enum=memory.Memory_Unit" json:"unit,omitempty"`
...
const file_memory_message_proto_rawDesc = "" +
	"\n" +
	"\x14memory_message.proto\x12\x06memory\"\xa7\x01\n" +
	"\x06Memory\x12\x14\n" +
	"\x05value\x18\x01 \x01(\x04R\x05value\x12'\n" +
	"\x04unit\x18\x02 \x01(\x0e2\x13.memory.Memory.UnitR\x04unit\"^\n" +
	"\x04Unit\x12\v\n" +
	...
	"\bTERABYTE\x10\x06B\x0eZ\fpcBook/pb;pbb\x06proto3"
...
var file_memory_message_proto_goTypes = []any{
	(Memory_Unit)(0), // 0: memory.Memory.Unit
	(*Memory)(nil),   // 1: memory.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: memory.Memory.unit:type_name -> memory.Memory.Unit
