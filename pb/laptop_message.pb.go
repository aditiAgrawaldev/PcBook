...
const file_laptop_message_proto_rawDesc = "" +
	"\n" +
	"\x14laptop_message.proto\x12\x06laptop\x1a\x17processor_message.proto\x1a\x14memory_message.proto\x1a\x16keyboard_message.proto\x1a\x15storage_message.proto\x1a\x14screen_message.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xf5\x03\n" +
	"\x06Laptop\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05brand\x18\x02 \x01(\tR\x05brand\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12 \n" +
	"\x03cpu\x18\x04 \x01(\v2\x0e.processor.CPUR\x03cpu\x12&\n" +
	"\x06memory\x18\x05 \x01(\v2\x0e.memory.MemoryR\x06memory\x12 \n" +
	"\x03gpu\x18\x06 \x03(\v2\x0e.processor.GPUR\x03gpu\x12*\n" +
	"\astorage\x18\a \x03(\v2\x10.storage.StorageR\astorage\x12&\n" +
	"\x06screen\x18\b \x01(\v2\x0e.screen.ScreenR\x06screen\x12.\n" +
	"\bkeyboard\x18\t \x01(\v2\x12.keyboard.KeyboardR\bkeyboard\x12\x1d\n" +
	"\tweight_kg\x18\n" +
	...
	"\x06weightB\x0eZ\fpcBook/pb;pbb\x06proto3"
...
var file_laptop_message_proto_goTypes = []any{
	(*Laptop)(nil),                // 0: laptop.Laptop
	(*CPU)(nil),                   // 1: processor.CPU
	(*Memory)(nil),                // 2: memory.Memory
	(*GPU)(nil),                   // 3: processor.GPU
	(*Storage)(nil),               // 4: storage.Storage
	(*Screen)(nil),                // 5: screen.Screen
	(*Keyboard)(nil),              // 6: keyboard.Keyboard
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
}
var file_laptop_message_proto_depIdxs = []int32{
	1, // 0: laptop.Laptop.cpu:type_name -> processor.CPU
	2, // 1: laptop.Laptop.memory:type_name -> memory.Memory
	3, // 2: laptop.Laptop.gpu:type_name -> processor.GPU
	4, // 3: laptop.Laptop.storage:type_name -> storage.Storage
	5, // 4: laptop.Laptop.screen:type_name -> screen.Screen
	6, // 5: laptop.Laptop.keyboard:type_name -> keyboard.Keyboard
	7, // 6: laptop.Laptop.updated_at:type_name -> google.protobuf.Timestamp
