...
type GPU struct {
	...
	Memory        *Memory                `protobuf:"bytes,5,opt,name=memory,proto3" json:"memory,omitempty"` // <-- uses memory_message.proto
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_processor_message_proto_rawDesc = "" +
	"\n" +
	"\x17processor_message.proto\x12\tprocessor\x1a\x14memory_message.proto\"\xab\x01\n" +
	"\x03CPU\x12\x14\n" +
	...
	"\x06memory\x18\x05 \x01(\v2\x0e.memory.MemoryR\x06memoryB\x0eZ\fpcBook/pb;pbb\x06proto3"
...
var file_processor_message_proto_goTypes = []any{
	(*CPU)(nil),    // 0: processor.CPU
	(*GPU)(nil),    // 1: processor.GPU
	(*Memory)(nil), // 2: memory.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: processor.GPU.memory:type_name -> memory.Memory
