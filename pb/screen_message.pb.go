...
type Screen struct {
	...
	Panel         Screen_Panel           `protobuf:"varint,3,opt,name=panel,proto3,enum=screen.Screen_Panel" json:"panel,omitempty"`
...
const file_screen_message_proto_rawDesc = "" +
	"\n" +
	"\x14screen_message.proto\x12\x06screen\"\x91\x02\n" +
	"\x06Screen\x12\x1b\n" +
	"\tsize_inch\x18\x01 \x01(\x02R\bsizeInch\x129\n" +
	"\n" +
	"resolution\x18\x02 \x01(\v2\x19.screen.Screen.ResolutionR\n" +
	"resolution\x12*\n" +
	"\x05panel\x18\x03 \x01(\x0e2\x14.screen.Screen.PanelR\x05panel\x12\x1e\n" +
	"\n" +
	...
	"\x04OLED\x10\x02B\x0eZ\fpcBook/pb;pbb\x06proto3"
...
var file_screen_message_proto_goTypes = []any{
	(Screen_Panel)(0),         // 0: screen.Screen.Panel
	(*Screen)(nil),            // 1: screen.Screen
	(*Screen_Resolution)(nil), // 2: screen.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: screen.Screen.resolution:type_name -> screen.Screen.Resolution
	0, // 1: screen.Screen.panel:type_name -> screen.Screen.Panel
