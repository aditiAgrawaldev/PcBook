...
type Keyboard struct {
	...
	Layout        Keyboard_Layout        `protobuf:"varint,1,opt,name=layout,proto3,enum=keyboard.Keyboard_Layout" json:"layout,omitempty"`
...
const file_keyboard_message_proto_rawDesc = "" +
	"\n" +
	"\x16keyboard_message.proto\x12\bkeyboard\"\x92\x01\n" +
	"\bKeyboard\x121\n" +
	"\x06layout\x18\x01 \x01(\x0e2\x19.keyboard.Keyboard.LayoutR\x06layout\x12\x18\n" +
	...
	"\n" +
	"\x06AZERTY\x10\x03B\x0eZ\fpcBook/pb;pbb\x06proto3"
...
var file_keyboard_message_proto_goTypes = []any{
	(Keyboard_Layout)(0), // 0: keyboard.Keyboard.Layout
	(*Keyboard)(nil),     // 1: keyboard.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: keyboard.Keyboard.layout:type_name -> keyboard.Keyboard.Layout
